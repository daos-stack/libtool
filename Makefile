...
PATCHES := libtool-2.4.5-rpath.patch libtool-2.4.6-am-1.16-test.patch \
	   libtool-2.4.6-specs.patch libtool-2.4.6-hardening.patch    \
	   libtool-2.4.6-fatal-handler.patch libtool-nodocs.patch
